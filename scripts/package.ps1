...
try {
    ...
    $releaseFiles = @('extension/manifest.json', 'extension/DisneyPlus-Edge-Enhanced.user.js', 'extension/background.mjs', 'extension/toolbar.mjs', 'extension/bridge.js', 'README.md', 'LICENSE', 'PRIVACY.md', 'NOTICE.md', 'docs/diagnostics.md', 'docs/related-issues.md', 'docs/intel-4k.md', 'docs/assets/readme-banner.png')
