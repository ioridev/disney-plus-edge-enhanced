...
const sessionStore = makeStorage([['ioridev.disneyplus4k.once.v0.5.1', JSON.stringify({version:'0.5.1', mode:testMode, documentUrl:'https://www.disneyplus.com/ja-jp/play/test', createdAt:Date.now()})]]);
...
assert.equal(sessionStore.getItem('ioridev.disneyplus4k.once.v0.5.1'), null, 'consume the ticket before the first EME call');
...
assert.equal(checkpoint.version, '0.5.1');
